...
public class VirtualChestInventory extends VirtualInventory {
    ...
    public VirtualChestInventory(InventoryHolder holder) {
        this(holder, null);
    }

    public VirtualChestInventory(InventoryHolder holder, String title) {
        super(InventoryType.CHEST, holder, title);
    }

    public VirtualChestInventory(InventoryType type, InventoryHolder holder, String title) {
