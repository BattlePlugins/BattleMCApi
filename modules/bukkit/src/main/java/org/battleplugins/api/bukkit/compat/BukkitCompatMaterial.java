package org.battleplugins.api.bukkit.compat;
...
public enum BukkitCompatMaterial {
    ...
    BRAIN_CORAL_WALL_FAN(0, "BRAIN_CORAL_WALL_FAN"),
    BREAD(0, "BREAD"),
    ...
    private static Map<String, BukkitCompatMaterial> cachedSearch = new HashMap<>();
    ...
    public static Optional<BukkitCompatMaterial> fromString(String key) {
    ...
    public static Optional<BukkitCompatMaterial> requestBukkitMaterial(String name, int data) {
