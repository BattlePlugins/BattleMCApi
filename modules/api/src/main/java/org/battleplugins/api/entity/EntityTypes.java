...
public class EntityTypes {
    ...
    public static final EntityType HOGLIN = getOrDefault("hoglin");
    ...
    public static final EntityType PIGLIN = getOrDefault("piglin");
    ...
    public static final EntityType STRIDER = getOrDefault("strider");
    ...
    public static final EntityType ZOGLIN = getOrDefault("zoglin");
    ...
    public static final EntityType ZOMBIFIED_PIGLIN = getOrDefault("zombified_piglin");
