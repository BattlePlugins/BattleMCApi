package org.battleplugins.api.nukkit.compat;

import lombok.Getter;

@Getter
public enum NukkitCompatEntityType {
    ...
    NukkitCompatEntityType(int type, float height) {
        this(type, height, 0f);
    }

    NukkitCompatEntityType(int type, float height, float width) {
        this(type, height, width, width);
    }

    NukkitCompatEntityType(int type, float height, float width, float length) {
        this(type, height, width, length, 0f);
    }

    NukkitCompatEntityType(int type, float height, float width, float length, float offset) {
        this.type = type;
        this.height = height;
        this.width = width;
        this.length = length;
